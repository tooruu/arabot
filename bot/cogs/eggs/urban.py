...
class Urban(Cog, name="Eggs"):
	...
	@text_reaction(send=False, regex=r"^(?:wh?[ao]t(?:['’]?s|\sis)\s)((?:(?!up|good|with|it|this|that|so|the|about|goin|happenin|wrong|your|ur).)*?)\??$", check=lambda msg: len(msg.content) < 30)
